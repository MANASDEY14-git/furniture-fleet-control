...
COMMENT ON TABLE public.items IS 'Items table - forced refresh ' || now()::text;
COMMENT ON TABLE public.item_variants IS 'Item variants table - forced refresh ' || now()::text;
