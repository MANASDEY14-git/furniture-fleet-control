-- Drop only the triggers that exist on actual tables
...
-- Now drop the functions (they may or may not exist)
DROP FUNCTION IF EXISTS public.handle_sales_variant_stock_v2();
DROP FUNCTION IF EXISTS public.handle_sales_variant_stock();
DROP FUNCTION IF EXISTS public.update_variant_stock_on_purchase();
DROP FUNCTION IF EXISTS public.update_parent_item_quantity_v2();
DROP FUNCTION IF EXISTS public.update_parent_item_quantity();
