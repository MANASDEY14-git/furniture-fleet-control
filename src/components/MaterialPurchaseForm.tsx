...
export default function MaterialPurchaseForm({ trigger }: MaterialPurchaseFormProps) {
  ...
  const handleQuantityChange = (quantity: number) => {
    ...
    setFormData(prev => ({ ...prev, quantity, total_cost: total }));
  };

  const handleUnitCostChange = (unitCost: number) => {
    const total = calculateTotalCost(formData.quantity, unitCost);
    setFormData(prev => ({ ...prev, unit_cost: unitCost, total_cost: total }));
  };
