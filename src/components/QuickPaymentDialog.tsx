...
export default function QuickPaymentDialog({ supplier, trigger }: QuickPaymentDialogProps) {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'cash' | 'upi' | 'bank_transfer' | 'cheque' | 'debit_card' | 'credit_card'>('bank_transfer');
  ...
  const showBankAccountSelector = paymentMethod !== 'cash';
          ...
          <div className="space-y-2">
            ...
            <Select value={paymentMethod} onValueChange={(v) => {
              ...
              <SelectContent className="bg-slate-800 border-blue-500/30">
                ...
                <SelectItem value="debit_card" className="text-blue-100 focus:bg-blue-800/30">
                  Debit Card
                </SelectItem>
                <SelectItem value="credit_card" className="text-blue-100 focus:bg-blue-800/30">
                  Credit Card
                </SelectItem>
              </SelectContent>
            </Select>
