...
export default function MultiItemSalesForm({ onSubmit, isLoading }: MultiItemSalesFormProps) {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button 
            ...
            disabled={isLoading || !formData.storeId || !formData.supplierId}
          >
            {isLoading ? 'Processing Sale...' : 'Execute Sale'}
          </Button>
        </form>
      </CardContent>
    </Card>
