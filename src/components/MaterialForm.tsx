...
const units = ['Units', 'Kg', 'Grams', 'Liters', 'Meters', 'Feet', 'Inches', 'Pieces', 'Boxes'];
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Enter material name" value={formData.name} onChange={e => setFormData({
              ...formData,
              name: e.target.value
            })} required className="neon-border bg-slate-800/50 text-blue-100 placeholder-blue-400" />
            </div>
            ...
            <div className="space-y-2">
              ...
              unit: value
                ...
                <SelectContent className="bg-slate-800 border-blue-500/30">
                  {units.map(unit => <SelectItem key={unit} value={unit} className="text-blue-100 focus:bg-blue-800/30">
                      {unit}
                    </SelectItem>)}
                </SelectContent>
              </Select>
            ...
            <div className="space-y-2">
              ...
              <Input id="quantity" type="number" step="0.01" placeholder="Enter quantity" value={formData.quantity_available || ''} onChange={e => setFormData({
              ...formData,
              quantity_available: parseFloat(e.target.value) || 0
            })} min="0" className="neon-border bg-slate-800/50 text-blue-100 placeholder-blue-400" />
            </div>

            <div className="space-y-2">
              <Label htmlFor="cost" className="text-blue-200">Cost Price *</Label>
              <Input id="cost" type="number" step="0.01" placeholder="Enter cost price" value={formData.cost_price || ''} onChange={e => setFormData({
              ...formData,
              cost_price: parseFloat(e.target.value) || 0
            })} required min="0" className="neon-border bg-slate-800/50 text-blue-100 placeholder-blue-400" />
            </div>
          ...
          <div className="flex gap-2 pt-4">
            <Button type="submit" disabled={isLoading} className="flex-1 cyber-button font-semibold text-primary-foreground">
