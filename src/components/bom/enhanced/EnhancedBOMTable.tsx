...
import { Edit, Eye, Trash2, AlertTriangle, CheckCircle, DollarSign, Filter, Target, Package } from 'lucide-react';
...
import { useEnhancedBOMList, useDeleteBOM, useBOMValidation } from '@/hooks/useEnhancedBOM';
            ...
            <div>
              ...
              {selectedStore && selectedStore !== 'all' && (
                <p className="text-sm text-muted-foreground mt-1">
                  Showing BOMs for items in selected store ({filteredBOMList.length} BOMs)
                </p>
              )}
            </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    {searchTerm 
                      ...
                      : selectedStore && selectedStore !== 'all'
                        ? 'No BOMs found for items in the selected store'
                        : 'Start by creating your first BOM'}
                  </p>
                </div>
              ) : (
