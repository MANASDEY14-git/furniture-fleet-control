...
export default function MultiItemPurchaseForm({ onSubmit, isLoading }: MultiItemPurchaseFormProps) {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button 
            ...
            disabled={isLoading || !formData.storeId || !formData.supplierId || !formData.invoiceNumber}
          >
