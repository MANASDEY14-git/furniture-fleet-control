-- Fix sales order column issue
-- Run this in your Supabase SQL Editor

-- Check the actual sales_order_items table structure
SELECT 
    column_name,
    data_type,
    is_nullable
...
BEGIN
    ...
    -- Add sales order item using order_id (the correct column name)
